...
void InitEPwm9Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO16 = 1;  //for mux option 5 ('b101) you have to set the corresponding select bits in global mux GPAGMUX2 register as 1 ('b01) along with value 1 ('b01) in select bits in GPAMUX2 register.
    GpioCtrlRegs.GPAGMUX2.bit.GPIO17 = 1;  //for mux option 5 ('b101) you have to set the corresponding select bits in global mux GPAGMUX2 register as 1 ('b01) along with value 1 ('b01) in select bits in GPAMUX2 register.
    GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 5;   // Configure GPIO16 as EPWM9A
    GpioCtrlRegs.GPAMUX2.bit.GPIO17 = 5;   // Configure GPIO17 as EPWM9B
...
void InitEPwm10Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO18 = 1;  //for mux option 5 ('b101) you have to set the corresponding select bits in global mux GPAGMUX2 register as 1 ('b01) along with value 1 ('b01) in select bits in GPAMUX2 register.
    GpioCtrlRegs.GPAGMUX2.bit.GPIO19 = 1;  //for mux option 5 ('b101) you have to set the corresponding select bits in global mux GPAGMUX2 register as 1 ('b01) along with value 1 ('b01) in select bits in GPAMUX2 register.
    GpioCtrlRegs.GPAMUX2.bit.GPIO18  = 5;   // Configure GPIO18 as EPWM10A
    GpioCtrlRegs.GPAMUX2.bit.GPIO19  = 5;   // Configure GPIO19 as EPWM10B
