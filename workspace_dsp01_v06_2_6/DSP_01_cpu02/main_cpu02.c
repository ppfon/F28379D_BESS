    ...
    /* for(resultsIndex2 = 0; resultsIndex2 < N_data_log; resultsIndex2++)
     {
         ...
         //plota_dsp1_cpu2[resultsIndex2] = 0;
     }
    */
     resultsIndex2 = 0;
...
//Loop infinito
    while(1)
    {
        ...
        //Carrega a flag relacionada com a entrada digital respons�vel por verificar se a flag Shutdown do conjunto 1 foi acionada
         flag.Com_DSP1_read = GpioDataRegs.GPADAT.bit.GPIO25;    //Estado do contator de conex�o com a rede
        //
    ...
    else
    {
           ...
           if(flag.data_logo_init == 1)
           {
               ...
               if(Counts.count9 >= COUNT_LIM_LOG)
               {
                   ...
                   //plota_dsp1_cpu2[resultsIndex2] = entradas_dc.Vbt_filt;
               }
            */
         ...
         /////////////////////////////////Variável auxiliar para Corrente no supervisório /////////////////
...
{
    GpioDataRegs.GPACLEAR.bit.GPIO24 = 1;           // Limpa a flag que informa para a DSP02 que a prote��o nesse conjunto foi acionada
...
void TUPA_StopSequence(void)
{
    //Verifica se a flag Shutdown_conv est� acionado ou se a Shutdown da CPU1 est� acionada (IPC6) e interrompe o chaveamento e abre os contatores
     if(flag.Shutdown_Conv == 1)
     {
         ...
         GpioDataRegs.GPASET.bit.GPIO24 = 1;           // Informa para a DSP02 que a prote��o nesse conjunto foi acionada
